...
UPDATE housing_states SET
  record_lookback_summary =
    ...
    || 'local rules.'
    || E'\n\n'
    || 'Federal fair housing law still applies to every landlord. A landlord who refuses everyone with '
    || 'any record, without looking at what the record is or how long ago it happened, may be breaking '
    || 'it. Housing counsellors and legal aid offices can tell you whether that is worth challenging '
    || 'in your situation.'
    || E'\n\n'
  ...
  notes =
    ...
    || 'ordinances.' || E'\n'
    || '• Fair Housing Act, 42 U.S.C. 3601 et seq. NOTE: this summary deliberately does NOT characterise '
