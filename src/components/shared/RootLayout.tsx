...
export default function RootLayout() {
  ...
  const emergencyUri = URL.canParse(emergencyUrl) ? new URL(emergencyUrl) : null
  const isEmergencyUrlSafe = emergencyUri?.protocol === 'https:' && emergencyUri.hostname === 'app.streetrise.org'
