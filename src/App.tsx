...
const TransportationPage   = lazy(() => import('@/pages/transportation/TransportationExperiencePage'))
const TransportationRequestPage = lazy(() => import('@/pages/transportation/TransportationRequestPage'))
    ...
    <Suspense fallback={<Loading />}>
      <Routes>
        ...
        <Route element={<RootLayout />}>
          ...
          {/* Transportation remains a specialized task-oriented view over
              canonical resources. Assistance programs may be service-area or
              phone based rather than map pins. */}
          <Route path="transportation" element={<TransportationPage />} />
          <Route path="transportation/request/:programId" element={<TransportationRequestPage />} />
